...
\usepackage{listings}
\usepackage{courier}
\renewcommand{\lstlistlistingname}{Lista de códigos fuente} 
...
%recién le anexé a el documento principal 
%\include{appendices/appResultadosSCL} 
\include{appendices/appResultadosSCL2}
\include{appendices/appc}
\include{appendices/appEstadisticas}
%\include{appendices/appJavaACSI}
    
\begin{singlespace} 
	%esta es la bibliografia standard de la IEEE
	\bibliographystyle{IEEEtran} %otra opción es 	%\bibliographystyle{plain}
