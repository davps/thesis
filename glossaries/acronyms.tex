...
name={Configured IED Description}]
...
%%%XSD
\newacronym[description={XML is a text format
which has a simple method to clasify 
elements names and attributes},
name={Extensible Markup Language}]
{XML}{XML}{Extensible Markup Language}


%%%XSD
\newacronym[description={XML Shema is used 
to describe the structure and restrictions 
of the XML documents. In the IEC 61850-6 
XSD files are asigned to SCL object models. 
},
