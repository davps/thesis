...
\title{Diseño del modelo IEC 61850 del regulador de velocidad 
...
%%de una unidad generadora tpica de
%%Itaipu

%Oootro título alternativo podría ser 
...
% Polit\'ecnica}
\supervisor{Prof. M.Sc. Ing. Rodrigo Ramos}{Área de ingeniería, Itaipu
Binacional} 
\supervisor{Prof. Ing. Ladislao Aranda Arriola}{Área de ingeniería, Itaipu
Binacional}
...
Trabajo Final de Grado de Ingeniería Eléctrica}
...
%Esta es la carátula standard del MIT. No la usé porque la UNE 
