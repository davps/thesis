...
As explained in section \ref{} \todo{completar referencia!}, 
...
\begin{figure}
  ...
  details \todo[inline]{a este le valta
...
\begin{figure}
  ...
  \caption{SCL Substation object model inherited \todo[inline]{a este le valta
  expandir la clase correspondiente hasta que muestre el transformador } }
