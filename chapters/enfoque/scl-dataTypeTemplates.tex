...
Según las directrices del EPRI \cite{Epri:2004}, 
uno de los primeros pasos del proceso de ingeniería 
para la 
especificación de sistemas de 
automatización de subestaciones usando la norma IEC 61850
consiste en identificar los datos
disponibles, y en base a estos datos, determinar 
los nodos lógicos correspondientes.

El autor de este trabajo realizó este paso 
escribiendo en el elemento \textbf{DataTypeTemplate}
de un sólo archivo SCL todos los nodos lógicos 
según los datos identificados del sistema. 
En este paso, aún no se ubican los nodos lógicos
en los dispositivos lógicos ni físicos. 
