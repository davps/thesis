...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Comando utiles, que utilizare despues }
Esta seccion es mi laboratorio de pruebas, el lector 
puede saltarse la lectura de esta
seccion, no tiene nada que ver 
con el tema de la tesis, aqui solo voy colocando y haciendo
pruebas de comandos \LaTeX que voy a utilizar en este documento.

footnotes \footnote{ esta es una prueba de pie de pagina... }

unbreakable text \mbox{ ... hello world! }

\marginpar{This note will appear in the margin.}

\subsection{\LaTeX comand testing}
...
\section{Preguntas}
	\begin{itemize}
	  \item El modelado IEC61850 es solo una parte de la \gls{SAS} verdad?
	  Que otras areas abarca \gls{SAS}?
	  \item Esta bien decir \gls{SCL} engineering para estos temas de 
	  modelado? y no \gls{SAS} engineering que es mas generico?
	\end{itemize}